...
public class ExternalFieldAssignmentAnalyzerTests
{
    ...
    [Fact]
    public Task FieldSetInObjectInitializer_IsClean()
    {
        const string source = """
            ...
            {
                public Options Make() => new Options
                {
                    Username = "name",
                };
            }
    ...
    [Fact]
    public Task FieldSetInNestedInitializer_IsClean()
    {
        const string source = """
            public sealed class Options
            {
            ...
            public sealed class Builder
            {
                public Container Make() => new Container
                {
                    Options =
                    {
                        Username = "name",
